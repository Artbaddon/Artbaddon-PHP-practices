        ...
        <div class="container-menu">
            ...
            <div class="container-product">
                ...
                ?>
                        ...
                        <form action="cart.php" method="post" class="form-container-product">
                            ...
                            <div class="box-product">
                                ...
                                <div class="product-container">
                                    ...
                                    <input type="hidden" name="name" value="<?= $fetch_product['nombre_Producto']; ?>">
                                    <input type="hidden" name="name" value="<?= $fetch_product['precio_Producto']; ?>">
